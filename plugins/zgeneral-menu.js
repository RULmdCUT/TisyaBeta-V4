/*
yt @tisyaachan tt @forupixar @ ig@unknopin
jangan asal hapus coding code nya kak
*/
...
╭───ＩＮＦＯ─────────>
│| え ʀᴜɴᴛɪᴍᴇ : %uptime
│| え ᴄʀᴇᴀᴛᴏʀ : AlvinStore
│| え ᴘᴇɴɢᴇᴍʙᴀɴɢ : ${author}
│| え ᴘʀᴇғɪx : [ %p ]
│| え ᴍᴏᴅᴇ : ${global.opts['self'] ? 'Private' : 'ᴘᴜʙʟɪᴄ'}
│| え ᴅᴀᴛᴀʙᴀsᴇ : *${Object.keys(global.db.data.users).length}* ᴘᴇɴɢɢᴜɴᴀ  
╎| え ᴜsᴇʀ ʙᴀɴɴᴇᴅ *${Object.entries(global.db.data.users).filter(user => user[1].banned).length}* 
╰─────────────────>
...
await conn.sendMessage(m.chat, {
            ...
            contextInfo: {
                externalAdReply: {
                    ...
                    title: '𝐓𝐢𝐬𝐲𝐚𝐚𝐂𝐡𝐚𝐧',
                    thumbnailUrl: 'https://telegra.ph/file/90e9ce8fb264233e92d4c.jpg',
                    sourceUrl: 'https://wa.me/628382341447',
                    mediaType: 1,
                    renderLargerThumbnail: true,
...
//========={[(END)]}==========//
      ...
      let vn = "./media/vn/vin.mp3"   
conn.sendFile(m.chat, vn, "vin.mp3", null, m, true, {
	 type: "audioMessage",
	 ptt: true,
 });
} catch (e) {
...
handler.command = /^(allmenu|help|alvin|tiysa)$/i
