...
Cara Penggunaan Command Contoh *.buysc*`,
}
let handler = async (m, {
    conn,
    usedPrefix: _p,
...
await conn.sendFile(m.chat, './media/alpin.mp3', '', null, m, true)  
        // Biasa
} catch (e) {
...
handler.tags = ['store']
handler.help = ['alvinshop']
handler.command = /^(alvinshop|shop)$/i
