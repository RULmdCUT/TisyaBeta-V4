let mufar = async (m, { conn }) => {
  ...
  conn.sendMessage(m.chat, { text: `*[ FRACTION LIST ]*\n\n ${tagList}\n\n*Total fitur:${totalfi} Commands*`, contextInfo: { externalAdReply: { title: wm, body: bottime, mediaType: 1, thumbnailUrl: 'https://telegra.ph/file/90e9ce8fb264233e92d4c.jpg', sourceUrl: 'https://s.id/alvinpin', renderLargerThumbnail: true } } }, { quoted: m, ephemeralExpiration: global.ephemeral })
}
