...
let menulist = async (m, { conn, args }) => {
  ...
  ✧
  ┬ 📌 𝐍𝐎𝐓𝐄 :
  │ 𝐉𝐚𝐧𝐠𝐚𝐧 𝐒𝐩𝐚𝐦 𝐁𝐨𝐭 𝐘𝐚 𝐊𝐚𝐤..
  ╰━━━━━━━━━━┈─◂
  ${readMore}\n╭━━━━━━━━┈─◂\n│≡ *TAG LIST*\n┴\n│${global.htjava} .menulist  ${daftarTag}\n╰━━━━━━━━┈─◂\n*Total Tag:${Object.keys(tagCount).length}*`, contextInfo: { externalAdReply: { title: wm, body: author, mediaType: 1, thumbnail: fs.readFileSync(prn), sourceUrl: 'https://s.id/alvinpin', renderLargerThumbnail: true } } }, { quoted: m, ephemeralExpiration: global.ephemeral });
    ...
    conn.sendMessage(m.chat, { document: fs.readFileSync("./package.json"),
      ...
      fileLength: 99999999999999,
      pageCount: 10909143,  
      caption:  `╭━━━━━━━━┈─◂\n│≡ *${perintah}*\n├━━━━━━━━┈─◂\n│\n│${global.pmenus}${daftarHelp}\n╰━━━━━━━━┈─◂\n\n*Total Item:${tagHelpMapping[perintah].length}*`, contextInfo: { externalAdReply: { title: wm, body: author, mediaType: 1, thumbnail: fs.readFileSync('./tumnil/1.jpg'), sourceUrl: 'https://s.id/alvinpin', renderLargerThumbnail: true } } }, { quoted: m, ephemeralExpiration: global.ephemeral });
  ...
  │ 𝐉𝐚𝐧𝐠𝐚𝐧 𝐒𝐩𝐚𝐦 𝐁𝐨𝐭 𝐘𝐚 𝐊𝐚𝐤..
  ╰━━━━━━━━━━┈─◂
${readMore}\n╭━━━━━━━━┈─◂\n│≡ *TAG LIST AND HELP*\n╰━━━━━━━━┈─◂\n\n${allTagsAndHelp}\n\n*Total Tags:${Object.keys(tagCount).length}*`, contextInfo: { externalAdReply: { title: wm, body: author, mediaType: 1, thumbnail: fs.readFileSync('./tumnil/1.jpg'), sourceUrl: 'https://s.id/alvinpin', renderLargerThumbnail: true } } }, { quoted: m, ephemeralExpiration: global.ephemeral });
  } else {
